...
The process of implementing *sha256* was made easier with the step by step explanation of the algorithm in the following website : [Sha256 Algorithm Explained](https://sha256algorithm.com/).
